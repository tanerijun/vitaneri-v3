...
import sample from "./images/transparent-gradient-example.jpeg";
...
<image src={sample} alt="Example of image fading into transparent" />
...
That's it :tada:. Hope you find it useful.
