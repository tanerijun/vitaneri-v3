...
import ConstantSpaceImg from "./images/constant-space.jpeg";
import LinearSpaceImg from "./images/linear-space.jpg";
import CallStackImg from "./images/call-stack.jpg";
...
<img src={ConstantSpaceImg} alt="Graph of constant space complexity" />
...
<img src={LinearSpaceImg} alt="Graph of linear space complexity" />
...
<img src={CallStackImg} alt="Image of the call stack" />
...
That's it for space complexity :tada:.
