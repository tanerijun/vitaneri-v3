...
As for space complexity, it's `Ω(n)`. In the worst case, the algorithm will have to put each number from the array into the map.

## Wrap Up

That's it for Two Sum with TypeScript. :tada:

Any question or suggestion is always welcomed. :blush:
